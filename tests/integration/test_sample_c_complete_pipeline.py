...
class TestSampleCCompletePipeline:
    ...
    def test_complete_gating_pipeline_sample_c(self, sample_c_events):
        ...
        singlet_gate = RectangleGate(
            ...
            "SSC-A",
            x_min=50_000,
            x_max=200_000,  # FSC range
            y_min=1_000,
            y_max=50_000,  # SSC range
        )
        ...
        lymphocyte_gate = RectangleGate(
            ...
            "SSC-A",
            x_min=40_000,
            x_max=120_000,  # Narrower FSC
            y_min=500,
            y_max=15_000,  # Narrower SSC
        )
        ...
        b_cell_gate = RectangleGate(
            ...
            "PE-A",
            x_min=1000,
            x_max=200_000,  # FITC positive
            y_min=0,
            y_max=5000,  # PE negative
        )
        ...
        t_cell_gate = RectangleGate(
            ...
            "PE-A",
            x_min=0,
            x_max=5000,  # FITC negative
            y_min=1000,
            y_max=200_000,  # PE positive
        )
        ...
        if len(t_cells) > 100:  # Only if we have enough T cells
            ...
            cd4_gate = RectangleGate(
                ...
                "APC-Cy7-A",
                x_min=1000,
                x_max=200_000,  # PerCP+ (CD4 proxy)
                y_min=0,
                y_max=5000,  # APC- (CD8 negative)
            )
            ...
            cd8_gate = RectangleGate(
                ...
                "APC-Cy7-A",
                x_min=0,
                x_max=5000,  # PerCP- (CD4 negative)
                y_min=1000,
                y_max=200_000,  # APC+ (CD8 positive)
            )
