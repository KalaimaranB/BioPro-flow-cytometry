...
def dummy_events():
    ...
    np.random.seed(42)
    return pd.DataFrame(
        {"FSC-A": np.random.normal(50000, 10000, 10000), "SSC-A": np.random.normal(50000, 10000, 10000)}
    )
...
def test_dag_boolean_and(dummy_events):
    ...
    # Gate A: X > 50k
    gate_a = PolygonGate(
        x_param="FSC-A", y_param="SSC-A", vertices=[(50000, 0), (100000, 0), (100000, 100000), (50000, 100000)]
    )
    ...
    # Gate B: Y > 50k
    gate_b = PolygonGate(
        x_param="FSC-A", y_param="SSC-A", vertices=[(0, 50000), (100000, 50000), (100000, 100000), (0, 100000)]
    )
