...
def test_dag_boolean_and(dummy_events):
    ...
    # Gate A: X > 50k
    gate_a = PolygonGate(x_param="FSC-A", y_param="SSC-A", vertices=[(50000, 0), (100000, 0), (100000, 100000), (50000, 100000)])
    node_a = GateNode(gate=gate_a, name="Gate A", parents=[root])
    root.children.append(node_a)
    
    # Gate B: Y > 50k
    gate_b = PolygonGate(x_param="FSC-A", y_param="SSC-A", vertices=[(0, 50000), (100000, 50000), (100000, 100000), (0, 100000)])
