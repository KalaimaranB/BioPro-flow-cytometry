...
class TestGateBoundaryBehaviorWithTransforms:
    ...
    def test_gate_near_boundaries_linear(self, sample_a_events):
        ...
        assert membership[1]  # 50_001 is inside
        assert not membership[0]  # 49_999 is outside
        assert membership[3]  # 199_999 is inside
        assert not membership[2]  # 200_001 is outside
