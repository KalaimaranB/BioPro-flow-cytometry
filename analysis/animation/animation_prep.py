...
class UmapAnimationDataPrep:
    ...
    def prepare(
        ...
        # 3. Compute Phase 1: 3D High-Dimensional proxy (PCA)
        try:
        ...
        # 4. Compute Phase 2: KNN Graph (Fuzzy Simplicial Complex proxy)
        try:
        ...
        # 5. Compute Phase 5: Final 2D Layout (Mini-UMAP — real, not faked)
