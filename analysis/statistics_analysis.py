...
class StatisticsAnalysis(AnalysisBase):
    ...
    def run(self, state: Any) -> dict[str, Any]:
        ...
        self._walk_and_compute(sample.gate_tree, events, total_count, total_count, results, root_events=events)
    ...
    def _walk_and_compute(self, node, parent_events, parent_count, total_count, results, root_events=None):
        ...
        for child in node.children:
            try:
                ...
                if is_logic_node:
                    ...
                    gated_events = child.apply_hierarchy(root_events if root_events is not None else parent_events)
            ...
            self._walk_and_compute(child, gated_events, count, total_count, results, root_events=root_events)
