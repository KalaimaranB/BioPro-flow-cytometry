...
class HexagonBadge(QWidget):
    ...
    def paintEvent(self, event):
        ...
        glow_color = QColor(base_color.red(), base_color.green(), base_color.blue(), int(40 + self._glow * 40))
        ...
        for i, n1 in enumerate(self._nodes):
            for n2 in self._nodes[i+1:]:
                ...
                if dist < 150:
                    ...
                    painter.setPen(QPen(QColor(accent.red(), accent.green(), accent.blue(), alpha), 1))
                    painter.drawLine(QPointF(n1['x']*w, n1['y']*h), QPointF(n2['x']*w, n2['y']*h))
